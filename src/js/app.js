...
function render(variables = {}) {
  ...
  let name = `${variables.name ? variables.name : "Ericka"}`;
  let lastName = `${variables.lastName ? variables.lastName : "Castillo"}`;
  let role = `${variables.role ? variables.role : "Web Developer"}`;
  let city = `${variables.city ? variables.city : "Lima"}`;
  let country = `${variables.country ? variables.country : "Peru"}`;
  let mediaPosition = `${
